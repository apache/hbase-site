import{j as e}from"./components-BCHf_v1I.js";import{_ as o,a as s}from"./hfilev2-L4pQhBIf.js";let l=`
...
<img alt="HFile V1 Format" src={__img0} />
...
<img alt="HFile Version 2 Structure" src={__img1} />
...
A version 2 HFile is structured as follows:`},{heading:"unified-version-2-block-format",content:"In the version 2 every block in the data section contains the following fields:"},{heading:"unified-version-2-block-format",content:`8 bytes: Block type, a sequence of bytes equivalent to version 1's "magic records". Supported block types are:`},{heading:"unified-version-2-block-format",content:"DATA – data blocks"},{heading:"unified-version-2-block-format",content:"LEAF\\_INDEX – leaf-level index blocks in a multi-level-block-index"},{heading:"unified-version-2-block-format",content:"BLOOM\\_CHUNK – Bloom filter chunks"},{heading:"unified-version-2-block-format",content:"META – meta blocks (not used for Bloom filters in version 2 anymore)"},{heading:"unified-version-2-block-format",content:"INTERMEDIATE\\_INDEX – intermediate-level index blocks in a multi-level blockindex"},{heading:"unified-version-2-block-format",content:"ROOT\\_INDEX – root-level index blocks in a multi-level block index"},{heading:"unified-version-2-block-format",content:'FILE\\_INFO – the "file info" block, a small key-value map of metadata'},{heading:"unified-version-2-block-format",content:"BLOOM\\_META – a Bloom filter metadata block in the load-on-open section"},{heading:"unified-version-2-block-format",content:"TRAILER – a fixed-size file trailer. As opposed to the above, this is not an HFile v2 block but a fixed-size (for each HFile version) data structure"},{heading:"unified-version-2-block-format",content:"INDEX\\_V1 – this block type is only used for legacy HFile v1 block"},{heading:"unified-version-2-block-format",content:`Compressed size of the block's data, not including the header (int).\\
Can be used for skipping the current data block when scanning HFile data.`},{heading:"unified-version-2-block-format",content:`Uncompressed size of the block's data, not including the header (int)\\
This is equal to the compressed size if the compression algorithm is NONE`},{heading:"unified-version-2-block-format",content:`File offset of the previous block of the same type (long)\\
Can be used for seeking to the previous data/index block`},{heading:"unified-version-2-block-format",content:"Compressed data (or uncompressed data if the compression algorithm is NONE)."},{heading:"unified-version-2-block-format",content:"The above format of blocks is used in the following HFile sections:"},{heading:"scanned-block-section",content:`The section is named so because it contains all data blocks that need to be read when an HFile is scanned sequentially.
...
StoreFile-level logic adds more keys to this.`},{heading:"file-info-format-in-versions-1-and-2",content:"Key"},{heading:"file-info-format-in-versions-1-and-2",content:"Description"},{heading:"file-info-format-in-versions-1-and-2",content:"hfile.LASTKEY"},{heading:"file-info-format-in-versions-1-and-2",content:"The last key of the file (byte array)"},{heading:"file-info-format-in-versions-1-and-2",content:"hfile.AVG\\_KEY\\_LEN"},{heading:"file-info-format-in-versions-1-and-2",content:"The average key length in the file (int)"},{heading:"file-info-format-in-versions-1-and-2",content:"hfile.AVG\\_VALUE\\_LEN"},{heading:"file-info-format-in-versions-1-and-2",content:"The average value length in the file (int)"},{heading:"file-info-format-in-versions-1-and-2",content:`In version 2, we did not change the file format, but we moved the file info to
the final section of the file, which can be loaded as one block when the HFile
...
`,e.jsx(n.p,{children:e.jsx(n.img,{alt:"HFile V1 Format",src:o})}),`
...
A version 2 HFile is structured as follows:`}),`
`,e.jsx(n.p,{children:e.jsx(n.img,{alt:"HFile Version 2 Structure",src:s})}),`
