import{j as e}from"./components-BCHf_v1I.js";let r=`Herein you will find either the definitive documentation on an HBase topic as of its
...
places throughout this guide. In the interest of clarity, here is a brief explanation
of what is generally meant by these phrases, in the context of HBase.`},{heading:"support-and-testing-expectations",content:`Commercial technical support for Apache HBase is provided by many Hadoop vendors. This is not the
sense in which the term *support* is used in the context of the Apache HBase project. The Apache
