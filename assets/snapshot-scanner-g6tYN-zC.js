import{j as e}from"./components-BCHf_v1I.js";let t=`In HBase, a scan of a table costs server-side HBase resources reading, formating, and returning data back to the client.
...
Based on this limitation, we can only sync up to 12 HBase granted users' ACLs. This means, if a table enables this feature, then the total users with table, namespace of this table, global READ permission should not be greater than 12.`},{heading:"limitation",content:"There are some cases that this coprocessor has not handled or could not handle, so the user HDFS ACLs are not synced normally. It will not make a reference link to another hfile of other tables."}],headings:[{id:"tablesnapshotscanner",content:"TableSnapshotScanner"},{id:"use-tablesnapshotscanner",content:"Use TableSnapshotScanner"},{id:"tablesnapshotinputformat",content:"TableSnapshotInputFormat"},{id:"use-tablesnapshotinputformat",content:"Use TableSnapshotInputFormat"},{id:"permission-to-access-snapshot-and-data-files",content:"Permission to access snapshot and data files"},{id:"hdfs-acls",content:"HDFS ACLs"},{id:"basic-idea",content:"Basic idea"},{id:"configuration-to-use-this-feature",content:"Configuration to use this feature"},{id:"limitation",content:"Limitation"}]},l=[{depth:2,url:"#tablesnapshotscanner",title:e.jsx(e.Fragment,{children:"TableSnapshotScanner"})},{depth:3,url:"#use-tablesnapshotscanner",title:e.jsx(e.Fragment,{children:"Use TableSnapshotScanner"})},{depth:2,url:"#tablesnapshotinputformat",title:e.jsx(e.Fragment,{children:"TableSnapshotInputFormat"})},{depth:3,url:"#use-tablesnapshotinputformat",title:e.jsx(e.Fragment,{children:"Use TableSnapshotInputFormat"})},{depth:2,url:"#permission-to-access-snapshot-and-data-files",title:e.jsx(e.Fragment,{children:"Permission to access snapshot and data files"})},{depth:3,url:"#hdfs-acls",title:e.jsx(e.Fragment,{children:"HDFS ACLs"})},{depth:3,url:"#basic-idea",title:e.jsx(e.Fragment,{children:"Basic idea"})},{depth:3,url:"#configuration-to-use-this-feature",title:e.jsx(e.Fragment,{children:"Configuration to use this feature"})},{depth:3,url:"#limitation",title:e.jsx(e.Fragment,{children:"Limitation"})}];function n(i){const s={a:"a",br:"br",code:"code",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...i.components};return e.jsxs(e.Fragment,{children:[e.jsxs(s.p,{children:[`In HBase, a scan of a table costs server-side HBase resources reading, formating, and returning data back to the client.
