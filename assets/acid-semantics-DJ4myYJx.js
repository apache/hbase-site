import{j as e,w as s}from"./components-BCHf_v1I.js";import{M as a}from"./mdx-components-BiKD0kRz.js";import"./mdx-BNLr6eYe.js";import"./index-D_Ppk8jy.js";import"./index-iRMX2DbM.js";import"./errorBoundaries-BdFLuvV-.js";import"./index-BltEbKL_.js";import"./utils-BLPMsyIW.js";import"./link-uBCqDJYa.js";import"./external-link-B9aqN57o.js";import"./createLucideIcon-Czfzc5TZ.js";e.jsx(e.Fragment,{children:"ACID properties of HBase"}),e.jsx(e.Fragment,{children:"Definitions"}),e.jsx(e.Fragment,{children:"APIs to consider"}),e.jsx(e.Fragment,{children:"Guarantees Provided"}),e.jsx(e.Fragment,{children:"Atomicity"}),e.jsx(e.Fragment,{children:"Consistency and Isolation"}),e.jsx(e.Fragment,{children:"Consistency of Scans"}),e.jsx(e.Fragment,{children:"Visibility"}),e.jsx(e.Fragment,{children:"Durability"}),e.jsx(e.Fragment,{children:"Tunability"}),e.jsx(e.Fragment,{children:"More Information"}),e.jsx(e.Fragment,{children:"Footnotes"});function i(n){const t={a:"a",em:"em",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",ol:"ol",p:"p",strong:"strong",ul:"ul",...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.h1,{id:"acid-properties-of-hbase",children:"ACID properties of HBase"}),`
...
`,e.jsx(t.p,{children:"[3] Puts will either wholly succeed or wholly fail, provided that they are actually sent to the RegionServer. If the writebuffer is used, Puts will not be sent until the writebuffer is filled or it is explicitly flushed."})]})}function r(n={}){const{wrapper:t}=n.components||{};return t?e.jsx(t,{...n,children:e.jsx(i,{...n})}):i(n)}function o(){return e.jsx(a,{Content:r,className:"mt-12"})}function y({}){return[{title:"ACID Semantics - Apache HBase"},{name:"description",content:"Apache HBase ACID properties and guarantees specification."}]}const b=s(function(){return e.jsx(o,{})});export{b as default,y as meta};
