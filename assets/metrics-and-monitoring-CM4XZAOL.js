import{j as e}from"./chunk-EPOLDU6W-B5LwAila.js";import{_ as l,a as h,b as c,c as d,d as g,e as m,f as p,g as u}from"./empty-snapshots-CrCCrRVe.js";let x=`
...
`,e.jsx(s.img,{alt:"empty snapshots",src:u,placeholder:"blur"})]}),`
...
`]}),`
`]}),`
`]})]})}function v(n={}){const{wrapper:s}=n.components||{};return s?e.jsx(s,{...n,children:e.jsx(o,{...n})}):o(n)}function a(n,s){throw new Error("Expected component `"+n+"` to be defined: you likely forgot to import, pass, or provide it.")}export{x as _markdown,v as default,E as extractedReferences,k as frontmatter,j as structuredData,y as toc};
