import{j as e}from"./components-BCHf_v1I.js";let s=`## Aspirational Semantic Versioning
...
`,e.jsx(n,{type:"warn",children:e.jsx(t.p,{children:e.jsx(t.em,{children:`Please note, this indicates what could break, not that it will break. We will/should add
specifics in our release notes.`})})}),`
`,e.jsxs(t.table,{children:[e.jsx(t.thead,{children:e.jsxs(t.tr,{children:[e.jsx(t.th,{}),e.jsx(t.th,{style:{textAlign:"center"},children:"Major"}),e.jsx(t.th,{style:{textAlign:"center"},children:"Minor"}),e.jsx(t.th,{style:{textAlign:"center"},children:"Patch"})]})}),e.jsxs(t.tbody,{children:[e.jsxs(t.tr,{children:[e.jsx(t.td,{children:"Client-Server wire Compatibility"}),e.jsx(t.td,{style:{textAlign:"center"},children:"N"}),e.jsx(t.td,{style:{textAlign:"center"},children:"Y"}),e.jsx(t.td,{style:{textAlign:"center"},children:"Y"})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{children:"Server-Server Compatibility"}),e.jsx(t.td,{style:{textAlign:"center"},children:"N"}),e.jsx(t.td,{style:{textAlign:"center"},children:"Y"}),e.jsx(t.td,{style:{textAlign:"center"},children:"Y"})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{children:"File Format Compatibility"}),e.jsxs(t.td,{style:{textAlign:"center"},children:["N ",e.jsx(t.sup,{children:e.jsx(t.a,{href:"#user-content-fn-3",id:"user-content-fnref-3","data-footnote-ref":!0,"aria-describedby":"footnote-label",children:"3"})})]}),e.jsx(t.td,{style:{textAlign:"center"},children:"Y"}),e.jsx(t.td,{style:{textAlign:"center"},children:"Y"})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{children:"Client API Compatibility"}),e.jsx(t.td,{style:{textAlign:"center"},children:"N"}),e.jsx(t.td,{style:{textAlign:"center"},children:"Y"}),e.jsx(t.td,{style:{textAlign:"center"},children:"Y"})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{children:"Client Binary Compatibility"}),e.jsx(t.td,{style:{textAlign:"center"},children:"N"}),e.jsx(t.td,{style:{textAlign:"center"},children:"N"}),e.jsx(t.td,{style:{textAlign:"center"},children:"Y"})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{children:e.jsx(t.strong,{children:"Server-Side Limited API Compatibility"})}),e.jsx(t.td,{style:{textAlign:"center"}}),e.jsx(t.td,{style:{textAlign:"center"}}),e.jsx(t.td,{style:{textAlign:"center"}})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{children:"→ Stable"}),e.jsx(t.td,{style:{textAlign:"center"},children:"N"}),e.jsx(t.td,{style:{textAlign:"center"},children:"Y"}),e.jsx(t.td,{style:{textAlign:"center"},children:"Y"})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{children:"→ Evolving"}),e.jsx(t.td,{style:{textAlign:"center"},children:"N"}),e.jsx(t.td,{style:{textAlign:"center"},children:"N"}),e.jsx(t.td,{style:{textAlign:"center"},children:"Y"})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{children:"→ Unstable"}),e.jsx(t.td,{style:{textAlign:"center"},children:"N"}),e.jsx(t.td,{style:{textAlign:"center"},children:"N"}),e.jsx(t.td,{style:{textAlign:"center"},children:"N"})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{children:"Dependency Compatibility"}),e.jsx(t.td,{style:{textAlign:"center"},children:"N"}),e.jsx(t.td,{style:{textAlign:"center"},children:"Y"}),e.jsx(t.td,{style:{textAlign:"center"},children:"Y"})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{children:"Operational Compatibility"}),e.jsx(t.td,{style:{textAlign:"center"},children:"N"}),e.jsx(t.td,{style:{textAlign:"center"},children:"N"}),e.jsx(t.td,{style:{textAlign:"center"},children:"Y"})]})]})]}),`
...
`,e.jsxs(t.p,{children:["Running an offline upgrade tool without downgrade might be needed. We will typically only support migrating data from major version X to major version X+1. ",e.jsx(t.a,{href:"#user-content-fnref-3","data-footnote-backref":"","aria-label":"Back to reference 3",className:"data-footnote-backref",children:"↩"})]}),`
`]}),`
`]}),`
