import{j as e}from"./components-BCHf_v1I.js";let l=`## Overview
...
commit is delegated to the specific Store File Tracking implementation.
The implementation can be set at the HBase service leve in **hbase-site.xml** or at the
Table or Column Family via the TableDescriptor configuration.`},{heading:"store-file-tracking-overview",content:`When the store file tracking implementation is specified in **hbase\\_site.xml**, this configuration
is also propagated into a tables configuration at table creation time. This is to avoid dangerous
...
feature, the Store File Tracking implementation can only be changed with the **MIGRATION**
implementation, so that the *new tracker* can safely build its list of tracked files based on the
list of the *current tracker*.`},{heading:"store-file-tracking-usage",content:`MIGRATION tracker should NOT be set at global configuration. To use it, follow below section about
...
table/column family to the desired tracker implementation.
An example of how to use *clone\\_snapshot* to specify the **FILE** tracker implementation
is shown below:`},{heading:"specifying-trackers-during-snapshot-recovery",content:`The option to specify the tracker during snapshot recovery is only available for the
*clone\\_snapshot* command. The *restore\\_snapshot* command does not support this parameter.`}],headings:[{id:"store-file-tracking-overview",content:"Overview"},{id:"available-implementations",content:"Available Implementations"},{id:"store-file-tracking-default",content:"DEFAULT"},{id:"file",content:"FILE"},{id:"migration",content:"MIGRATION"},{id:"store-file-tracking-usage",content:"Usage"},{id:"configuring-for-table-or-column-family",content:"Configuring for Table or Column Family"},{id:"switching-trackers-at-table-or-column-family",content:"Switching trackers at Table or Column Family"},{id:"specifying-trackers-during-snapshot-recovery",content:"Specifying trackers during snapshot recovery"}]},d=[{depth:2,url:"#store-file-tracking-overview",title:e.jsx(e.Fragment,{children:"Overview"})},{depth:2,url:"#available-implementations",title:e.jsx(e.Fragment,{children:"Available Implementations"})},{depth:3,url:"#store-file-tracking-default",title:e.jsx(e.Fragment,{children:"DEFAULT"})},{depth:3,url:"#file",title:e.jsx(e.Fragment,{children:"FILE"})},{depth:3,url:"#migration",title:e.jsx(e.Fragment,{children:"MIGRATION"})},{depth:2,url:"#store-file-tracking-usage",title:e.jsx(e.Fragment,{children:"Usage"})},{depth:3,url:"#configuring-for-table-or-column-family",title:e.jsx(e.Fragment,{children:"Configuring for Table or Column Family"})},{depth:3,url:"#switching-trackers-at-table-or-column-family",title:e.jsx(e.Fragment,{children:"Switching trackers at Table or Column Family"})},{depth:3,url:"#specifying-trackers-during-snapshot-recovery",title:e.jsx(e.Fragment,{children:"Specifying trackers during snapshot recovery"})}];function s(t){const i={code:"code",em:"em",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...t.components},{Callout:n}=i;return n||a("Callout"),e.jsxs(e.Fragment,{children:[e.jsx(i.h2,{id:"store-file-tracking-overview",children:"Overview"}),`
