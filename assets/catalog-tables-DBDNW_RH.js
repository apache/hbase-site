import{j as e}from"./chunk-EPOLDU6W-B5LwAila.js";let r=`The catalog table \`hbase:meta\` exists as an HBase table and is filtered out of the HBase shell's \`list\` command, but is in fact a table just like any other.
