import{j as e}from"./components-BCHf_v1I.js";import{_ as t,a as r,b as h}from"./backup-cloud-appliance--qbLnXgy.js";let d=`
...
<img alt="Intra-Cluster Backup" src={__img0} />
...
<img alt="Dedicated HDFS Cluster Backup" src={__img1} />
...
<img alt="Backup to Cloud or Vendor Storage Solutions" src={__img2} />
...
shows how these strategies are implemented and identifies potential tradeoffs with each.`},{heading:"planning",content:`This backup and restore tools has not been tested on Transparent Data Encryption (TDE) enabled
HDFS clusters. This is related to the open issue
...
to third-party vendors and that are located off-site. The vendor can be a public cloud provider or a storage vendor who uses
a Hadoop-compatible file system, such as S3 and other HDFS-compatible destinations.`},{heading:"backup-to-the-cloud-or-a-storage-vendor-appliance",content:`The HBase backup utility does not support backup to multiple destinations. A workaround is to
...
as it does not provide any additional safety on top of what the software itself already provides.`}),`
`,e.jsx(s.p,{children:e.jsx(s.img,{alt:"Intra-Cluster Backup",src:t})}),`
...
`,e.jsx(s.p,{children:e.jsx(s.img,{alt:"Dedicated HDFS Cluster Backup",src:r})}),`
...
to third-party vendors and that are located off-site. The vendor can be a public cloud provider or a storage vendor who uses
a Hadoop-compatible file system, such as S3 and other HDFS-compatible destinations.`}),`
`,e.jsx(s.p,{children:e.jsx(s.img,{alt:"Backup to Cloud or Vendor Storage Solutions",src:h})}),`
