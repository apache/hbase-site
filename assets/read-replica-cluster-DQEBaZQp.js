import{j as e}from"./chunk-QUQL4437-Bywy9pC_.js";let l=`## Background
...
org.apache.hadoop.hbase.security.access intercept every user-table mutation path and throw
WriteAttemptedOnReadOnlyClusterException (a DoNotRetryIOException) with the message
Operation not allowed in Read-Only Mode:`},{heading:"global-read-only-mode",content:"Class"},{heading:"global-read-only-mode",content:"Coprocessor host"},{heading:"global-read-only-mode",content:"Blocks"},{heading:"global-read-only-mode",content:"MasterReadOnlyController"},{heading:"global-read-only-mode",content:"Master"},{heading:"global-read-only-mode",content:"DDL, snapshots, splits, merges, namespace ops, ACL/quota ops, replication-peer ops"},{heading:"global-read-only-mode",content:"RegionReadOnlyController"},{heading:"global-read-only-mode",content:"Region"},{heading:"global-read-only-mode",content:"put, delete, batchMutate, checkAnd*, append, increment, flush, compaction, WAL append, commit/replay"},{heading:"global-read-only-mode",content:"RegionServerReadOnlyController"},{heading:"global-read-only-mode",content:"RegionServer"},{heading:"global-read-only-mode",content:"WAL roll, replication sink mutations, log replay"},{heading:"global-read-only-mode",content:"BulkLoadReadOnlyController"},{heading:"global-read-only-mode",content:"Region"},{heading:"global-read-only-mode",content:"bulk-load prepare/cleanup"},{heading:"global-read-only-mode",content:"EndpointReadOnlyController"},{heading:"global-read-only-mode",content:"Region"},{heading:"global-read-only-mode",content:"all coprocessor endpoint invocations"},{heading:"global-read-only-mode",content:`Operators do not load these classes manually. CoprocessorConfigurationUtil.syncReadOnlyConfigurations
adds them to hbase.coprocessor.master.classes, hbase.coprocessor.regionserver.classes, and
hbase.coprocessor.region.classes at startup and on every dynamic
ConfigurationManager.notifyAllObservers event — so the flag can be flipped at runtime with
...
`,e.jsxs(s.table,{children:[e.jsx(s.thead,{children:e.jsxs(s.tr,{children:[e.jsx(s.th,{children:"Class"}),e.jsx(s.th,{children:"Coprocessor host"}),e.jsx(s.th,{children:"Blocks"})]})}),e.jsxs(s.tbody,{children:[e.jsxs(s.tr,{children:[e.jsx(s.td,{children:e.jsx(s.code,{children:"MasterReadOnlyController"})}),e.jsx(s.td,{children:"Master"}),e.jsx(s.td,{children:"DDL, snapshots, splits, merges, namespace ops, ACL/quota ops, replication-peer ops"})]}),e.jsxs(s.tr,{children:[e.jsx(s.td,{children:e.jsx(s.code,{children:"RegionReadOnlyController"})}),e.jsx(s.td,{children:"Region"}),e.jsx(s.td,{children:"put, delete, batchMutate, checkAnd*, append, increment, flush, compaction, WAL append, commit/replay"})]}),e.jsxs(s.tr,{children:[e.jsx(s.td,{children:e.jsx(s.code,{children:"RegionServerReadOnlyController"})}),e.jsx(s.td,{children:"RegionServer"}),e.jsx(s.td,{children:"WAL roll, replication sink mutations, log replay"})]}),e.jsxs(s.tr,{children:[e.jsx(s.td,{children:e.jsx(s.code,{children:"BulkLoadReadOnlyController"})}),e.jsx(s.td,{children:"Region"}),e.jsx(s.td,{children:"bulk-load prepare/cleanup"})]}),e.jsxs(s.tr,{children:[e.jsx(s.td,{children:e.jsx(s.code,{children:"EndpointReadOnlyController"})}),e.jsx(s.td,{children:"Region"}),e.jsx(s.td,{children:"all coprocessor endpoint invocations"})]})]})]}),`
