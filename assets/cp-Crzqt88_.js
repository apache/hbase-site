import{j as s}from"./chunk-EPOLDU6W-B5LwAila.js";let h=`HBase Coprocessors are modeled after Google BigTable's coprocessor implementation
...
an easier way to load a coprocessor dynamically.`},{heading:"using-the-java-api-hbase-096-only",content:"type: warn"},{heading:"using-the-java-api-hbase-096-only",content:`There is no guarantee that the framework will load a given Coprocessor successfully. For example,
the shell command neither guarantees a jar file exists at a particular location nor verifies
