import{j as e}from"./components-BCHf_v1I.js";let c=`## Branches
...
These labels appear at the head of a class.
The conventions followed by HBase are inherited by its parent project, Hadoop.`},{heading:"interface-classifications",content:"The following interface classifications are commonly used:"},{heading:"interfaceaudience",content:"`@InterfaceAudience.Public`\\\nAPIs for users and HBase applications.\nThese APIs will be deprecated through major versions of HBase."},{heading:"interfaceaudience",content:"`@InterfaceAudience.Private`\\\nAPIs for HBase internals developers.\nNo guarantees on compatibility or availability in future versions.\nPrivate interfaces do not need an `@InterfaceStability` classification."},{heading:"interfaceaudience",content:"`@InterfaceAudience.LimitedPrivate(HBaseInterfaceAudience.COPROC)`\\\nAPIs for HBase coprocessor writers."},{heading:"interfaceaudience",content:"**No `@InterfaceAudience` Classification**:\\\nPackages without an `@InterfaceAudience` label are considered private.\nMark your new packages if publicly accessible."},{heading:"interfaceaudience",content:"Only interfaces classified `@InterfaceAudience.Public` should be included in API documentation\n(Javadoc). Committers must add new package excludes `ExcludePackageNames` section of the *pom.xml*\nfor new packages which do not contain public classes."},{heading:"interfacestability",content:"`@InterfaceStability` is important for packages marked `@InterfaceAudience.Public`."},{heading:"interfacestability",content:"`@InterfaceStability.Stable`\\\nPublic packages marked as stable cannot be changed without a deprecation path or a very good reason."},{heading:"interfacestability",content:"`@InterfaceStability.Unstable`\\\nPublic packages marked as unstable can be changed without a deprecation path."},{heading:"interfacestability",content:"`@InterfaceStability.Evolving`\\\nPublic packages marked as evolving may be changed, but it is discouraged."},{heading:"interfacestability",content:"**No `@InterfaceStability` Label**:\nPublic classes with no `@InterfaceStability` label are discouraged, and should be considered implicitly unstable."},{heading:"interfacestability",content:"If you are unclear about how to mark packages, ask on the development list."},{heading:"code-formatting-conventions",content:`Please adhere to the following guidelines so that your patches can be reviewed more quickly.
...
Deleting ZooKeeper data related to replication may cause replication to be disabled.
Do not delete the replication tree, &#x2A;/hbase/replication/*.`},{heading:"no-permanent-state-in-zookeeper",content:`Replication may be disrupted and data loss may occur if you delete the replication tree
(&#x2A;/hbase/replication/*) from ZooKeeper. Follow progress on this issue at
...
For this the MetricsAssertHelper is provided.`},{heading:"git-best-practices",content:"**Avoid git merges.**\\\nUse `git pull --rebase` or `git fetch` followed by `git rebase`."},{heading:"git-best-practices",content:"**Do not use `git push --force`.**\\\nIf the push does not work, fix the problem or ask for help."},{heading:"git-best-practices",content:"Please contribute to this document if you think of other Git best practices."},{heading:"rebase_all_git_branchessh",content:`The *dev-support/rebase\\_all\\_git\\_branches.sh* script is provided to help keep your Git repository clean.
Use the \`-h\` parameter to get usage instructions.
The script automatically refreshes your tracking branches, attempts an automatic rebase of each local branch against its remote branch, and gives you the option to delete any branch which represents a closed \`HBASE-\` JIRA.
The script has one optional configuration option, the location of your Git directory.
You can set a default by editing the script.
...
how to create pull requests.`},{heading:"github",content:`This section is incomplete and needs to be updated. Refer to
...
A non-binding vote is a vote by a non-committer.`},{heading:"becoming-a-committer",content:"Provide input for discussion threads on the mailing lists (which usually have\n`[DISCUSS]` in the subject line)."},{heading:"becoming-a-committer",content:`Answer questions on the user or developer mailing lists and on
Slack.`},{heading:"becoming-a-committer",content:`Make sure the HBase community is a welcoming one and that we adhere to our
Code of conduct. Alert the PMC if you
...
labeling new issues, updating metadata, and other tasks as needed.`},{heading:"becoming-a-committer",content:"Mentor new contributors of all sorts."},{heading:"becoming-a-committer",content:`Give talks and write blogs about HBase. Add these to the News section
...
PR number — i.e. PR-289 in our example — and then, when you've arrived at the PR page,
find the 'Build with Parameters' menu-item (along top left-hand menu). Click here and
then \`Build\` leaving the JIRA\\_ISSUE\\_KEY empty. This will re-run your checks.`},{heading:"dialog",content:`Committers should hang out in the #hbase room on irc.freenode.net for real-time discussions.
...
A non-binding vote is a vote by a non-committer.`]}),`
`,e.jsxs(t.li,{children:["Provide input for discussion threads on the ",e.jsx(t.a,{href:"/mailing-lists",children:"mailing lists"}),` (which usually have
`,e.jsx(t.code,{children:"[DISCUSS]"})," in the subject line)."]}),`
`,e.jsx(t.li,{children:`Answer questions on the user or developer mailing lists and on
Slack.`}),`
`,e.jsxs(t.li,{children:[`Make sure the HBase community is a welcoming one and that we adhere to our
`,e.jsx(t.a,{href:"/code-of-conduct",children:"Code of conduct"}),`. Alert the PMC if you
have concerns.`]}),`
...
`,e.jsxs(t.li,{children:["Give talks and write blogs about HBase. Add these to the ",e.jsx(t.a,{href:"/news",children:"News"}),` section
of the website.`]}),`
