import{j as e}from"./chunk-QUQL4437-Bywy9pC_.js";let h=`Apache HBase by default manages a ZooKeeper "cluster" for you.
...
in the entire Java process. All ZooKeeper clients running in the same process will pick them up
including co-processors.`},{heading:"java-system-properties",content:"type: info"},{heading:"java-system-properties",content:`Since ZooKeeper version 3.8 the following two properties are useful to store the keystore and
...
settings are also available in hbase-site.xml via hbase.zookeeper.property prefix. In contrast
to Java system properties this could be more convenient under some circumstances.`},{heading:"hbase-configuration",content:"type: info"},{heading:"hbase-configuration",content:`These settings are eventually transformed into Java system properties, it's just a convenience
