import{j as e}from"./components-BCHf_v1I.js";let o=`## HBase Data Model Terminology
...
A new column qualifier (column\\_family:column\\_qualifier) can be added to an existing column family at any time.`},{heading:"columnfamily-anchor-toc",content:"Row Key"},{heading:"columnfamily-anchor-toc",content:"Time Stamp"},{heading:"columnfamily-anchor-toc",content:"Column Family `anchor`"},{heading:"columnfamily-anchor-toc",content:'"com.cnn.www"'},{heading:"columnfamily-anchor-toc",content:"t9"},{heading:"columnfamily-anchor-toc",content:'`anchor:cnnsi.com = "CNN"`'},{heading:"columnfamily-anchor-toc",content:'"com.cnn.www"'},{heading:"columnfamily-anchor-toc",content:"t8"},{heading:"columnfamily-anchor-toc",content:'`anchor:my.look.ca = "CNN.com"`'},{heading:"columnfamily-contents-toc",content:"Row Key"},{heading:"columnfamily-contents-toc",content:"Time Stamp"},{heading:"columnfamily-contents-toc",content:"ColumnFamily `contents:`"},{heading:"columnfamily-contents-toc",content:'"com.cnn.www"'},{heading:"columnfamily-contents-toc",content:"t6"},{heading:"columnfamily-contents-toc",content:'contents:html = "\\<html>..."'},{heading:"columnfamily-contents-toc",content:'"com.cnn.www"'},{heading:"columnfamily-contents-toc",content:"t5"},{heading:"columnfamily-contents-toc",content:'contents:html = "\\<html>..."'},{heading:"columnfamily-contents-toc",content:'"com.cnn.www"'},{heading:"columnfamily-contents-toc",content:"t3"},{heading:"columnfamily-contents-toc",content:'contents:html = "\\<html>..."'},{heading:"columnfamily-contents-toc",content:"The empty cells shown in the conceptual view are not stored at all.\nThus a request for the value of the `contents:html` column at time stamp `t8` would return no value.\nSimilarly, a request for an `anchor:my.look.ca` value at time stamp `t9` would return no value.\nHowever, if no timestamp is supplied, the most recent value for a particular column would be returned.\nGiven multiple versions, the most recent is also the first one found, since timestamps are stored in descending order.\nThus a request for the values of all columns in the row `com.cnn.www` if no timestamp is specified would be: the value of `contents:html` from timestamp `t6`, the value of `anchor:cnnsi.com` from timestamp `t9`, the value of `anchor:my.look.ca` from timestamp `t8`."},{heading:"columnfamily-contents-toc",content:"For more information about the internals of how Apache HBase stores data, see regions.arch."},{heading:"namespace",content:`A namespace is a logical grouping of tables analogous to a database in relation database systems.
